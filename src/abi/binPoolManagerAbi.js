export const binPoolManagerAbi =[
    ...
    {
        "type": "error",
        "name": "BinPool__EmptyLiquidityConfigs",
        "inputs": []
    },
    {
        "type": "error",
        "name": "BinPool__InsufficientAmountUnSpecified",
        "inputs": []
    },
    {
        "type": "error",
        "name": "BinPool__InvalidBurnInput",
        "inputs": []
    },
    {
        "type": "error",
        "name": "BinPool__MaxLiquidityPerBinExceeded",
        "inputs": []
    },
    {
        "type": "error",
